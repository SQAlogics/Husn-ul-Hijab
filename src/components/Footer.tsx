...
const Footer = () => {
  return (
    <>
      ...
      <footer className="max-w-screen-2xl mx-auto border-b-8 border-secondaryBrown px-5 max-[400px]:px-3">
        ...
        <div className="flex flex-col gap-8 my-20">
          ...
          <h2 className="text-6xl font-light text-center max-sm:text-5xl">HUSN-UL-HIJAB</h2>
    ...
    <p className="text-base text-center max-sm:text-sm">Contact us on Whatsapp: +92.310.1019020</p>
        </div>
      </footer>
    </>
  );
